...
public class DatabaseApp {
	...
	public static void main(String[] args) {
		// using this simple app you can add/remove/search users or add/remove/search announcements - let me show you how... 
		...
		BookAnnouncement book = new BookAnnouncement("Thinking in Java", "Stan niezbyt idealny", "45.99", seller, "Bruce Eckel", BookCategory.popularnonakowa, 2006);
